...
struct handler_t {
    ...
    int ca; // num of A threads blocked
    int cb; // num of B threads blocked
    int cr; // num of R threads blocked

    int na; // num of A threads running
    int nb; // num of B threads running
    int nr; // num of R threads running
